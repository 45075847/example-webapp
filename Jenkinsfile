    ...
    stages {
        ...
        stage('Integration Tests') {
            ...
            steps {
                ...
                script {
                    TEST_ALB_LISTENER_ARN="arn:aws:elasticloadbalancing:us-east-1:089778365617:listener/xxx" 
                    /*
                    sh """
        ...
        stage('Deploy to Production - AWS CloudFormation') {
            ...
            steps {
                script {
                    PRODUCTION_ALB_LISTENER_ARN="arn:aws:elasticloadbalancing:us-east-1:089778365617:listener/xxx"
                    /*sh '''
